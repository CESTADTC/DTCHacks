    ...
    >
      ...
      >
        ...
        <p className="mt-10 max-w-2xl text-sm">
          <span className="text-primary">Note: </span> Are you a student at DELHI TECHNICAL CAMPUS? If not, ahh sorry, you're a little bit early. We are organizing a hackathon for inter-college students in upcoming February. This Hackathon is just for the students of Delhi Technical Campus.
          <br />
          <br />
          <a
